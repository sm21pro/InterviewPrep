...
public class EncryptedWords {
    String findEncryptedWord(String s) {
        ...
        // <= is important here. It could be empty string during recursion
        if (length <= 1) {
            return s;
        }
        ...
        String result = s.charAt(middleIndex) + findEncryptedWord(s.substring(0, middleIndex)) + findEncryptedWord(s.substring(middleIndex + 1));
        return result;
    }

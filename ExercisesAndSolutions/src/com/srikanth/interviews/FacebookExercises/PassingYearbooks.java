...
// My Note: 3 4 2 1 is an invalid input since they wont get it back
 */
...
public class PassingYearbooks {
    ...
    static int swapPositions(int arr[], Map<Integer, Integer> track, int[] result) {
        int equalCount = 0;
    ...
    int[] findSignatureCounts(int[] arr) {
        ...
        int swapCount = swapPositions(arr, track, result);
        while (swapCount != arr.length) {
            swapCount = swapPositions(arr, track, result);
        }
